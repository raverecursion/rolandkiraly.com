...
And that's it! I now have a functioning movie review site. There are a few more features that you can go and check out on [ScuffedMDB](https://movie.michael-hall.me), and if you want to host it for your friend group there is a [guide](https://github.com/mah51/movie-web-typescript).

(Section to come -> Posting to reddit and what I have changed :).)
