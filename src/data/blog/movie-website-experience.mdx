...
<VStack mt={2} alignItems='flex-start'>
  <Checkbox colorScheme='main' isReadOnly defaultIsChecked>
    Automatic movie details
  </Checkbox>
  <Checkbox colorScheme='main' isReadOnly>
    Authentication
  </Checkbox>
</VStack>
...
The card component looks like this:
...
And that's it! I now have a functioning movie review site.
